...
export interface RouteDefinition {
  id: string;
  path: string;
  family: "PUBLIC" | "AUTH" | "TEAM" | "ACCOUNT" | "ADMIN" | "SYSTEM";
  title: string;
  description: string;
  section: string;
  navigation: string;
...
export const routeManifest = [
  {
    id: "legacy_activation",
    path: "/activate-legacy",
    family: "AUTH",
    title: "Əvvəlki komandanı bərpa et",
    description: "Hesabın aktivləşdirilməsi və müstəqil sahiblik yoxlaması.",
    section: "auth",
    navigation: "/activate-legacy",
    capability: "register",
    indexable: false,
  },
  {
    id: "account_legacy_claim",
    path: "/account/legacy-claim",
    family: "ACCOUNT",
    title: "Köhnə komanda sahibliyi",
    description: "Əvvəlki komandanın hesabınıza təhlükəsiz bağlanması.",
    section: "account",
    navigation: "/account/legacy-claim",
    capability: "publicSession",
    indexable: false,
  },
  {
    id: "admin_legacy_claims",
    path: "/admin/legacy-claims",
    family: "ADMIN",
    title: "Sahiblik yoxlaması",
    description: "Əvvəlki komandaların müstəqil sahiblik yoxlaması.",
    section: "admin",
    navigation: "/admin/legacy-claims",
  ...
  },
  {
    ...
    family: "TEAM",
    title: "Public profil",
    description: "Komandanın ictimai kimliyi və media önbaxışı.",
    section: "management",
    navigation: "/team/profile",
  ...
  },
  {
    ...
    family: "TEAM",
    title: "Karyera",
    description: "Rəsmi karyera, xəritə statistikası və Wrapped.",
    section: "career",
    navigation: "/team/career",
    capability: "teamWorkspace",
    indexable: false,
  },

  {
    ...
    description:
      "Azərbaycan PUBG Mobile icması üçün yarış bələdçisi və təsdiqlənmiş komandalar.",
    section: "public",
    navigation: "/",
    indexable: true,
  },
  ...
  },
  {
    ...
    description:
      "Komanda heyəti, yarış qaydaları, xal formulu və iştirak şərtləri.",
    section: "public",
    navigation: "/tournaments",
    indexable: true,
  },
  ...
  },
  {
    ...
    description:
      "Yarış qaydaları və ictimai buraxılış imkanları haqqında kömək.",
    section: "public",
    navigation: "",
    indexable: true,
  },
  ...
  },
  {
    ...
    description:
      "AEVIC-də ictimai görünürlüyü təsdiqlənmiş komanda kimlikləri.",
    section: "public",
    navigation: "/teams",
    indexable: true,
  },
  ...
  },
  {
    ...
    description:
      "Təsdiqlənmiş komanda kimliyi və mənbədə mövcud olan ictimai məlumatlar.",
    section: "public",
    navigation: "/teams",
    indexable: false,
  },
...
export function routePath(
  id: (typeof routeManifest)[number]["id"],
  parent = "",
) {
...
export function matchRoute(pathname: string): RouteDefinition | undefined {
  ...
  return candidates
    .filter(
      ({ parts }) =>
        parts.length === clean.split("/").length &&
        parts.every((part, index) =>
          part.startsWith(":")
            ? Boolean(clean.split("/")[index])
            : part === clean.split("/")[index],
        ),
    )
    .sort(
      (a, b) =>
...
export function routeIsAccessible(
  route: RouteDefinition,
  capabilities: ServiceCapabilities,
) {
  return (
    routeIsAvailable(route, capabilities) ||
