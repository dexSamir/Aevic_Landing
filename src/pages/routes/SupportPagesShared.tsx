...
export const faqs = [
  ...
  ['pubg', 'PUBG ID ictimai görünür?', 'Heyətdə göstərilən PUBG ID oyunçunun ictimai profilini müəyyənləşdirir. Hesab e-poçtu, şifrə və şəxsi əlaqə məlumatları ictimai profildə göstərilmir.'],
